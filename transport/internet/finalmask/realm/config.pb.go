...
type Config struct {
	...
	IpMode        Family                 `protobuf:"varint,8,opt,name=ip_mode,json=ipMode,proto3,enum=xray.transport.internet.finalmask.realm.Family" json:"ip_mode,omitempty"`
...
func (x *Config) GetIpMode() Family {
	if x != nil {
		return x.IpMode
	}
	return Family_Dual
...
const file_transport_internet_finalmask_realm_config_proto_rawDesc = "" +
	...
	"\blifetime\x18\x03 \x01(\x03R\blifetime\"\xf8\x02\n" +
	"\x06Config\x12\x16\n" +
	...
	"\n" +
	"tls_config\x18\a \x01(\v2#.xray.transport.internet.tls.ConfigR\ttlsConfig\x12H\n" +
	"\aip_mode\x18\b \x01(\x0e2/.xray.transport.internet.finalmask.realm.FamilyR\x06ipMode\x12W\n" +
...
var file_transport_internet_finalmask_realm_config_proto_depIdxs = []int32{
	...
	0, // 1: xray.transport.internet.finalmask.realm.Config.ip_mode:type_name -> xray.transport.internet.finalmask.realm.Family
	1, // 2: xray.transport.internet.finalmask.realm.Config.port_mapping:type_name -> xray.transport.internet.finalmask.realm.PortMapping
