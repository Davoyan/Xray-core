...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\x14max_incoming_streams\x18\r \x01(\x03R\x12maxIncomingStreams\x12G\n" +
	" brutal_disable_loss_compensation\x18\x0e \x01(\bR\x1dbrutalDisableLossCompensation\x122\n" +
