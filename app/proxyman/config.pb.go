...
func (x *ReceiverConfig) GetSmuxSettings() *SmuxConfig {
	if x != nil {
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\n" +
	"route_only\x18\x05 \x01(\bR\trouteOnly\"\xa9\x03\n" +
	...
	"\x11sniffing_settings\x18\x06 \x01(\v2!.xray.app.proxyman.SniffingConfigR\x10sniffingSettings\x12B\n" +
	"\rsmux_settings\x18\a \x01(\v2\x1d.xray.app.proxyman.SmuxConfigR\fsmuxSettingsJ\x04\b\x05\x10\x06\"\xc0\x01\n" +
...
var file_app_proxyman_config_proto_depIdxs = []int32{
	...
	7,  // 6: xray.app.proxyman.ReceiverConfig.smux_settings:type_name -> xray.app.proxyman.SmuxConfig
	14, // 7: xray.app.proxyman.InboundHandlerConfig.receiver_settings:type_name -> xray.common.serial.TypedMessage
