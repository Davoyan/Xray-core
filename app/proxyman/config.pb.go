...
type SenderConfig struct {
	...
	SmuxSettings      *SmuxConfig             `protobuf:"bytes,7,opt,name=smux_settings,json=smuxSettings,proto3" json:"smux_settings,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SenderConfig) GetSmuxSettings() *SmuxConfig {
	if x != nil {
...
type SmuxConfig struct {
	...
	OnlyTcp        bool                   `protobuf:"varint,7,opt,name=only_tcp,json=onlyTcp,proto3" json:"only_tcp,omitempty"`
...
func (x *SmuxConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SmuxConfig) ProtoMessage() {}

func (x *SmuxConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_proxyman_config_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SmuxConfig.ProtoReflect.Descriptor instead.
func (*SmuxConfig) Descriptor() ([]byte, []int) {
	return file_app_proxyman_config_proto_rawDescGZIP(), []int{7}
}

func (x *SmuxConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *SmuxConfig) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *SmuxConfig) GetMaxConnections() int32 {
	if x != nil {
...
func (x *SmuxConfig) GetMinStreams() int32 {
	if x != nil {
		return x.MinStreams
	}
	return 0
...
func (x *SmuxConfig) GetMaxStreams() int32 {
	if x != nil {
		return x.MaxStreams
	}
	return 0
...
func (x *SmuxConfig) GetPadding() bool {
	if x != nil {
		return x.Padding
	}
	return false
...
func (x *SmuxConfig) GetOnlyTcp() bool {
	if x != nil {
		return x.OnlyTcp
	}
	return false
...
func (x *SmuxConfig) GetBrutal() *BrutalConfig {
	if x != nil {
		return x.Brutal
	}
	return nil
...
type BrutalConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enabled       bool                   `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	UpBps         uint64                 `protobuf:"varint,2,opt,name=up_bps,json=upBps,proto3" json:"up_bps,omitempty"`
	DownBps       uint64                 `protobuf:"varint,3,opt,name=down_bps,json=downBps,proto3" json:"down_bps,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BrutalConfig) GetUpBps() uint64 {
	if x != nil {
		return x.UpBps
	}
	return 0
...
func (x *BrutalConfig) GetDownBps() uint64 {
	if x != nil {
		return x.DownBps
	}
	return 0
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\x0fxudpProxyUDP443\x18\x04 \x01(\tR\x0fxudpProxyUDP443\"\x9b\x02\n" +
	"\n" +
	"SmuxConfig\x12\x18\n" +
	...
	"\x06brutal\x18\b \x01(\v2\x1f.xray.app.proxyman.BrutalConfigR\x06brutal\"Z\n" +
	"\fBrutalConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x15\n" +
	"\x06up_bps\x18\x02 \x01(\x04R\x05upBps\x12\x19\n" +
	"\bdown_bps\x18\x03 \x01(\x04R\adownBpsBU\n" +
...
var file_app_proxyman_config_proto_goTypes = []any{
	...
	(*SmuxConfig)(nil),            // 7: xray.app.proxyman.SmuxConfig
	(*BrutalConfig)(nil),          // 8: xray.app.proxyman.BrutalConfig
...
var file_app_proxyman_config_proto_depIdxs = []int32{
	...
	10, // 1: xray.app.proxyman.SniffingConfig.ips_excluded:type_name -> xray.common.geodata.IPRule
	11, // 2: xray.app.proxyman.ReceiverConfig.port_list:type_name -> xray.common.net.PortList
	12, // 3: xray.app.proxyman.ReceiverConfig.listen:type_name -> xray.common.net.IPOrDomain
	13, // 4: xray.app.proxyman.ReceiverConfig.stream_settings:type_name -> xray.transport.internet.StreamConfig
	1,  // 5: xray.app.proxyman.ReceiverConfig.sniffing_settings:type_name -> xray.app.proxyman.SniffingConfig
	14, // 6: xray.app.proxyman.InboundHandlerConfig.receiver_settings:type_name -> xray.common.serial.TypedMessage
	14, // 7: xray.app.proxyman.InboundHandlerConfig.proxy_settings:type_name -> xray.common.serial.TypedMessage
	12, // 8: xray.app.proxyman.SenderConfig.via:type_name -> xray.common.net.IPOrDomain
	13, // 9: xray.app.proxyman.SenderConfig.stream_settings:type_name -> xray.transport.internet.StreamConfig
	15, // 10: xray.app.proxyman.SenderConfig.proxy_settings:type_name -> xray.transport.internet.ProxyConfig
	6,  // 11: xray.app.proxyman.SenderConfig.multiplex_settings:type_name -> xray.app.proxyman.MultiplexingConfig
	16, // 12: xray.app.proxyman.SenderConfig.target_strategy:type_name -> xray.transport.internet.DomainStrategy
